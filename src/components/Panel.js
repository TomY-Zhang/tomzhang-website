...
export const TitlePanel = () => {
    return (
        <div id="TitlePanel" class="flex justify-center items-center h-screen w-full text-center">
            <h1 class="text-indigo-600 font-rockwell fade-in text-5xl md:text-6xl">Hey, I'm Tom Zhang.</h1>
        </div>
    );
}
    ...
    return (
        <div class="flex flex-col text-center justify-center h-auto w-full p-10 fade-in">
            ...
            <div class="flex flex-row justify-center gap-10 place-items-center h-full">
                ...
                <p class="w-108 font-mono text-center md:text-left text-indigo-800 text-xl sm:text-lg sm:h-full">
...
export const InterestsPanel = () => {
    return (
        <div class="flex flex-col text-center justify-center h-auto w-full p-28 fade-in">
...
export const CareerPanel = () => {
    return (
        <div class="grid grid-col place-content-center h-auto w-full fade-in p-10 pt-28 gap-3">
